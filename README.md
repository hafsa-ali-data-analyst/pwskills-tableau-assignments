...
1. Tableau Public – for creating dashboards and visualizations
2. Microsoft Excel / CSV – as data sources
3. GitHub – to upload and organize assignments
...
* Git Clone: https://github.com/hafsa-ali-data-analyst/pwskills-tableau-assignments.git

* Open the Tableau Workbook (.twb or .twbx) files using Tableau Public to view and interact with the dashboards.
